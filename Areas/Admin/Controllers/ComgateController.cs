...
using Payments.Comgate.Models;

namespace Payments.Comgate.Areas.Admin.Controllers
{
    [AuthorizeAdmin]
    [Area("Admin")]
    [PermissionAuthorize(PermissionSystemName.PaymentMethods)]
    public class ComgateController : BasePaymentController
    {
        ...
        public ComgateController(IWorkContext workContext,
        ...
        public async Task<IActionResult> Configure()
        {
            ...
            var payPalStandardPaymentSettings = _settingService.LoadSetting<ComgatePaymentSettings>(storeScope);
